...
class PromptRunnerText:
    ...
    def __init__(self, prompt_path: str, model: str = "gpt-5.1-codex-mini"):
        load_dotenv()
...
if __name__ == "__main__":
    # === CONFIGURATION ===
    input_folder = Path(r"D:\_as_developer\slr_screening\data\test_data\screening_validation\cleaned_text")        # Folder containing .txt files
    prompt_file = Path(r"prompt\full_text_screening_pr_v012.yaml")
    output_csv_path = Path(r"data/test_data/screening_validation/screening_result/07_full_screening_result_v012_51codexmin_run7.csv")

    runner = PromptRunnerText(prompt_file, model="gpt-5.1-codex-mini")
