...
if __name__ == "__main__":
    # === CONFIGURATION ===
    input_folder = Path(r"data\test_data\screening_validation\cleaned_text")        # Folder containing .txt files
    prompt_file = Path(r"prompt\full_text_screening_pr_v012.yaml")
    output_csv_path = Path(r"data\test_data\screening_validation\screening _result\full_screening_results-v012-41mini_run6.csv")
